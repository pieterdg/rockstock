...
public class CountryResourceIT {
    ...
    public void createCountry() throws Exception {
        ...
        assertThat(testCountry.getShortName()).isEqualTo(DEFAULT_SHORT_NAME);
    }
    ...
    public void updateCountry() throws Exception {
        ...
        assertThat(testCountry.getShortName()).isEqualTo(UPDATED_SHORT_NAME);
    }
