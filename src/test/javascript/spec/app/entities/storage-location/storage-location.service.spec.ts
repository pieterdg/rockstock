...
describe('Service Tests', () => {
  describe('StorageLocation Service', () => {
    ...
    let elemDefault: IStorageLocation;
    ...
    beforeEach(() => {
      ...
      expectedResult = null;
      injector = getTestBed();
      service = injector.get(StorageLocationService);
      httpMock = injector.get(HttpTestingController);

      elemDefault = new StorageLocation(0, 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a StorageLocation', () => {
        ...
        service.create(new StorageLocation()).subscribe(resp => (expectedResult = resp.body));
