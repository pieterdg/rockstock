...
import { StorageLocationComponent } from 'app/entities/storage-location/storage-location.component';
...
describe('Component Tests', () => {
  describe('StorageLocation Management Component', () => {
    let comp: StorageLocationComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(StorageLocationComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.storageLocations && comp.storageLocations[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
