...
import { SpecimenComponent } from 'app/entities/specimen/specimen.component';
...
describe('Component Tests', () => {
  describe('Specimen Management Component', () => {
    let comp: SpecimenComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(SpecimenComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.specimen && comp.specimen[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
