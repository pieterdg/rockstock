...
import { MineralComponent } from 'app/entities/mineral/mineral.component';
...
describe('Component Tests', () => {
  describe('Mineral Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.minerals && comp.minerals[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
