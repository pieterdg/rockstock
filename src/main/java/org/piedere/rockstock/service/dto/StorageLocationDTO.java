...
/**
 * A DTO for the {@link org.piedere.rockstock.domain.StorageLocation} entity.
 */
public class StorageLocationDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (storageLocationDTO.getId() == null || getId() == null) {
            return false;
        }
        return Objects.equals(getId(), storageLocationDTO.getId());
    }
