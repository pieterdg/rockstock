package org.piedere.rockstock.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, org.piedere.rockstock.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, org.piedere.rockstock.repository.UserRepository.USERS_BY_EMAIL_CACHE);
