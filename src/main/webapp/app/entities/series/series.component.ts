...
export class SeriesComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number): void {
    ...
    this.seriesService
      ...
      .subscribe(
        (res: HttpResponse<ISeries[]>) => this.onSuccess(res.body, res.headers, pageToLoad),
        () => this.onError()
      );
  }
  ...
  registerChangeInSeries(): void {
    this.eventSubscriber = this.eventManager.subscribe('seriesListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: ISeries[] | null, headers: HttpHeaders, page: number): void {
