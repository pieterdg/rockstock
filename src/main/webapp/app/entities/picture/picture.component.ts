...
export class PictureComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number): void {
    ...
    this.pictureService
      ...
      .subscribe(
        (res: HttpResponse<IPicture[]>) => this.onSuccess(res.body, res.headers, pageToLoad),
        () => this.onError()
      );
  }
  ...
  registerChangeInPictures(): void {
    this.eventSubscriber = this.eventManager.subscribe('pictureListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IPicture[] | null, headers: HttpHeaders, page: number): void {
